...
The product is split into `packages/web` and `packages/server`. The server runs from TypeScript source via `tsx`, serves `packages/web/dist`, and listens at [http://127.0.0.1:3141](http://127.0.0.1:3141).
